 ...
 */
     ...
     */
    public RiffHeader(short format, short numChannels, int sampleRate, short bitsPerSample, int numBytes) {
        mFormat = format;
     ...
     */
    public RiffHeader setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public RiffHeader setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public RiffHeader setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public RiffHeader setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public RiffHeader setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }
