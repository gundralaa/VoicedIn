...
public class SentimentAnalysisResult {
    ...
    private static String sentimentPath = "/text/analytics/v2.0/sentiment";
    ...
    public SentimentAnalysisResult(String queryText) {
    ...
    public void runSentimentAnalysis() {
        try {
            SentimentAnalysisTask task = new SentimentAnalysisTask();
        ...
        protected String doInBackground(String... queries) {
            ...
            try {
                ...
                try {
                    ...
                    SentimentScore = firstValue.getString("score");
                }catch (JSONException je) {
                    SentimentScore = "Exception thrown";
